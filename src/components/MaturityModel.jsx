            ...
            <tbody>
              {rows.map((row, i) => (
                <tr key={row.domain} className={i % 2 === 0 ? "bg-white" : "bg-culligan-off-white"}>
                  <td className="px-4 py-4 font-semibold text-culligan-deep whitespace-nowrap">{row.domain}</td>
                  <td className="px-4 py-4 text-culligan-body font-bold whitespace-nowrap">{row.score}</td>
                  <td className="px-4 py-4 text-culligan-muted whitespace-nowrap">{row.level}</td>
                  <td className="px-4 py-4 text-culligan-muted">{row.current}</td>
                  <td className="px-4 py-4 text-culligan-body">{row.target}</td>
                  <td className="px-4 py-4 text-culligan-amber font-semibold whitespace-nowrap">{row.gap}</td>
                </tr>
              ))}
            </tbody>
          </table>
